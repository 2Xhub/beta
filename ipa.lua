...
ImageButton.Image = "rbxassetid://17188041806"
...
spawn(function() 
    ...
    wait(.3)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>Welcome To LTD Hub<Color=/>"):Display()
    wait(.2)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Owner : ! LTDX<Color=/>"):Display()
    wait(.3)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Channel : LTDGAMING<Color=/>"):Display()
    wait(.4)
...
local Window = OrionLib:MakeWindow({
    Name = "LTD Hub", 
    HidePremium = false,
    IntroText = "LTD Library", 
    SaveConfig = true, 
    ConfigFolder = "LTD Hub"
})
...
function Notify(Hiri, Mi)
    OrionLib:MakeNotification({
        Name = "[LTD Hub]",
        Content = Hiri,
        Image = "rbxassetid://17188041806",
        Time = Mi
    })
end

local I = Window:MakeTab({Name = "Info", Icon = "rbxassetid://17188041806", PremiumOnly = false })
local G = Window:MakeTab({Name = "General", Icon = "rbxassetid://17188041806", PremiumOnly = false })
local ST = Window:MakeTab({Name = "Settings", Icon = "rbxassetid://17188041806", PremiumOnly = false })
local IQ = Window:MakeTab({Name = "Item & Quest", Icon = "rbxassetid://17188041806", PremiumOnly = false })
local LC = Window:MakeTab({Name = "LocalPlayer", Icon = "rbxassetid://17188041806", PremiumOnly = false })
local RD = Window:MakeTab({Name = "Raid & Devil Fruit", Icon = "rbxassetid://17188041806", PremiumOnly = false })
local SV = Window:MakeTab({Name = "Status and Servers", Icon = "rbxassetid://17188041806", PremiumOnly = false })
local RC = Window:MakeTab({Name = "Upgrated Race", Icon = "rbxassetid://17188041806", PremiumOnly = false })
local SE = Window:MakeTab({Name = "Sea Event", Icon = "rbxassetid://17188041806", PremiumOnly = false })
